---
title: "FIN 4950 Spring 2027 Syllabus"
...
| Category         | Links                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Tools            | [Canvas](https://southeastern.instructure.com/) \| [Video Lessons]({{< relref "video-lessons" >}})                                                                                                                                                                                                                                                                                                                           |
| Class Pages      | [FIN 4950 Home]({{< relref "home" >}}) \| [Spring 2027 Syllabus]({{< relref "syllabus" >}})                                                                                                                                                                                                                                                                                                                                  |
| Learning Modules | [Part 1]({{< relref "modules/part-1" >}}) \| [Part 2]({{< relref "modules/part-2" >}}) \| [Part 3]({{< relref "modules/part-3" >}})                                                                                                                                                                                                                                                                                          |
| Projects         | [Project 1]({{< relref "projects/project-1" >}}) \| [Project 2]({{< relref "projects/project-2" >}}) \| [Project 3]({{< relref "projects/project-3" >}}) \| [Project 4]({{< relref "projects/project-4" >}}) \| [Project 5]({{< relref "projects/project-5" >}}) \| [Project 6]({{< relref "projects/project-6" >}}) \| [Project 7]({{< relref "projects/project-7" >}}) \| [Project 8]({{< relref "projects/project-8" >}}) |
| Exams            | [Exam 1]({{< relref "exams/exam-1" >}}) \| [Exam 2]({{< relref "exams/exam-2" >}})                                                                                                                                                                                                                                                                                                                                           |
...
Readings will come from the required course [textbooks]({{< relref "home#textbooks" >}}) and any additional materials provided in [Canvas](https://southeastern.instructure.com/).
...
Canvas will be the official communication platform for this course. Course announcements, assignment instructions, grades, feedback, and important updates will be posted through Canvas. You are responsible for checking [Canvas](https://southeastern.instructure.com/) regularly so that you do not miss important course information.
...
Violations of academic honesty may result in a grade penalty for the assignment, quiz, exam, or project, and may also be referred through the University's student conduct process. Southeastern's Student Code of Conduct states that students are responsible for reading and abiding by its provisions. See Southeastern Louisiana University's [Student Code of Conduct/Know the Code Campaign](https://www.southeastern.edu/admin/osaa/know_the_code/).

Official source: [Southeastern Louisiana University Student Code of Conduct](https://www.southeastern.edu/wp-content/uploads/osaa/student-code-conduct.pdf)
